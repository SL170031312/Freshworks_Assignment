...
7. Appropriate error responses must always be returned to a client if it uses the data store in unexpected ways 
or breaches any limits.

#Go through the assignment.py file that is attached here, in order to understand clearly how 
the code works and how to perform operations.
